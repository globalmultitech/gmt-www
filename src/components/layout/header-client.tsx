    ...
    <header className={cn(
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex-shrink-0">
                 <Logo companyName={companyName} logoUrl={logoUrl} forceWhiteText={!isScrolled || isScrolled} />
            </div>
            ...
            <div className="hidden lg:flex justify-center flex-1">
              <nav className="flex items-center space-x-8 text-base font-medium">
                  ...
                  <Link
                      ...
                      className={cn(
                        'transition-colors',
                        isScrolled ? 'text-primary-foreground hover:text-primary-foreground/80' : 'text-primary-foreground hover:text-primary-foreground/80',
            ...
            <div className="hidden lg:flex items-center space-x-4">
                <Button asChild variant="outline" className={cn(
                   isScrolled ? 'border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary' : 'border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary'
                )}>
            ...
            <div className="lg:hidden flex items-center">
                ...
                <SheetTrigger asChild>
                    <Button variant="ghost" size="icon" className={cn(isScrolled ? 'text-primary-foreground hover:bg-muted/20' : 'text-primary-foreground hover:bg-muted/20')}>
