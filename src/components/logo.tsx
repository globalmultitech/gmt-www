...
export function Logo({ className, companyName = "Global Multi Technology", logoUrl, isScrolled = false }: { className?: string, companyName?: string, logoUrl?: string | null, isScrolled?: boolean }) {
  return (
